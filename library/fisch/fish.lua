...
return {
	...
	["Redwood Duskray"] = {
		...
		Seasons = {"Autumn"};
		Weather = {"Clear"};
		Quips = {"A Redwood Duskray!", "Duskâ€™s tough flyer!", "Redwood ruler!"};
	...
	["Pine Zephyrfish"] = {
		...
		Resilience = 30;
		ProgressEfficiency = 0.65;
		Description = "A swift zephyr that dances with pineâ€™s might.";
		...
		Seasons = {"Spring"};
		Weather = {"Windy"};
		Quips = {"A PINE ZEPHYRFISH!", "WINDâ€™S CHAMPION!", "PINE POWER!"};
	...
	Murkdrifter = {
		...
		Hint = "It roams when the rains awaken the nightâ€™s embrace.";
		FavouriteBait = "Shrimp";
		FavouriteTime = "Night";
		Price = 45;
		XP = 23;
	...
	["Canopy Tetra"] = {
		...
		Description = "A light green fish with yellow fins and a faint blue shimmer, flitting like a leaf in the canopyâ€™s shade.";
	...
	["Pyre Fang"] = {
		...
		Hint = "It lurks where the haze fuels the daylightâ€™s glow.";
		FavouriteBait = "Worm";
		FavouriteTime = "Day";
		Price = 37;
		XP = 18;
	...
	["Sulfur Snapper"] = {
		...
		Hint = "Its glare cuts through the foggy nightâ€™s heat.";
		FavouriteBait = "Squid";
		FavouriteTime = "Night";
		Price = 165;
		XP = 70;
	...
	["Sunflare Tetra"] = {
		...
		Resilience = 49;
		ProgressEfficiency = 0.9;
		Description = "A vibrant fish, its fins radiating like the sunâ€™s fleeting touch.";
	...
	["Cinder Dart"] = {
		...
		Hint = "It streaks through the misty renewalâ€™s glow.";
		FavouriteBait = "Insect";
		FavouriteTime = nil;
		Price = 1270;
		XP = 605;
	...
	Emberwing = {
		...
		Hint = "Its wings flare in the foggy nightâ€™s glow.";
		FavouriteBait = "Ember Berries";
		FavouriteTime = "Night";
		Price = 1365;
		XP = 650;
	...
	Tropicspike = {
		...
		Hint = "It spikes through the restless frostâ€™s blaze.";
		FavouriteBait = "Golden Worm";
		FavouriteTime = nil;
		Price = 4515;
		XP = 2150;
	...
	Tidallow = {
		...
		Hint = "It gleams under the sunâ€™s gentle rays.";
		FavouriteBait = "Worm";
		FavouriteTime = "Day";
		Price = 41;
		XP = 20;
	...
	["Horizon Tetra"] = {
		...
		Resilience = 45;
		ProgressEfficiency = 0.92;
		Description = "A shimmering metallic blue fish with yellow fins, glinting at the waterâ€™s edge.";
	...
	["Lantern Snapper"] = {
		...
		Resilience = 28;
		ProgressEfficiency = 0.4;
		Description = "A tiny red fish glowing like a lantern, illuminating the reefâ€™s shadows.";
	...
	Murkslither = {
		...
		Seasons = {"Winter"};
		Weather = {"Rain"};
		Quips = {"A Murkslither!", "Slithers like death!", "Murkâ€™s champion!"};
		SparkleColor = Color3.fromRGB(0, 0, 0);
		HoldAnimation = fish:WaitForChild("tiny");
		From = "The Cursed Shores";
		Worlds = {"Sea 2"};
	...
	["Crawling Angler"] = {
		...
		Seasons = {"Autumn"};
		Weather = {"Foggy"};
		Quips = {"A Crawling Angler!", "Crawl of death!", "Anglerâ€™s wrath!"};
		SparkleColor = Color3.fromRGB(0, 0, 0);
		HoldAnimation = fish:WaitForChild("basic");
		From = "The Cursed Shores";
		Worlds = {"Sea 2"};
	...
	["Abyssborn Monstrosity"] = {
		...
		Description = "A colossal terror birthed from the abyssâ€™s cruel heart.";
	...
	["Lagoon Dart"] = {
		...
		Hint = "It dashes under the warm rainâ€™s embrace.";
		FavouriteBait = "Shrimp";
		FavouriteTime = "Night";
		Price = 110;
		XP = 55;
	...
	["Azure Prowler"] = {
		...
		Hint = "It hunts under the clear duskâ€™s glow.";
		FavouriteBait = "Mist Worms";
		FavouriteTime = "Night";
		Price = 1750;
		XP = 905;
	...
	["Depth Drifter"] = {
		...
		Resilience = 1;
		ProgressEfficiency = 0.08;
		Description = "A cyan blue fish with large light blue fins, drifting through the lagoonâ€™s abyss.";
	...
	["Verdant Mirage"] = {
		...
		Description = "A dark cyan fish with bright light blue accents, a mirage in the lagoonâ€™s heart.";
